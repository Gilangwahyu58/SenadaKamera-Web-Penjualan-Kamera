...
<div class="container">
    ...
    <div class="table-sriped">
      <form action="simpan_komen.php" method="POST">
        <table>
          ...
          <tr>
            <td colspan="2">
              <textarea class="form-control" type="text" name="komentar" placeholder="Isikan Komentar Anda."></textarea>
            </td>
          </tr>
          <tr>
            <td colspan="2">
              <button type="submit" name="simpan" class="btn btn-warning">Kirim</button>
            </td>
          </tr>
        </table>
      </form>
  ...
  <?php
  // Lakukan pemrosesan dan tampilkan komentar yang sudah disimpan
