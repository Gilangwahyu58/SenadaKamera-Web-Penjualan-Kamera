...
$prefix = 'D'; // Awalan kode produk berdasarkan jenis
...
$query = mysqli_query($koneksi, "SELECT MAX(kd_barang) AS max_code FROM tbl_product WHERE kd_barang LIKE '$prefix%'");
$data = mysqli_fetch_assoc($query);
$latest_code = $data['max_code'];

if ($latest_code) {
    $number = substr($latest_code, 1); // Ambil nomor setelah awalan
...
<div class="container">
  ...
  <form action="product/drone/simpan_product.php" method="POST" enctype="multipart/form-data">
