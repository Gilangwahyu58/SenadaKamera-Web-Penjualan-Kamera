...
?>
    <div class="container">
        <h2>Data Kamera</h2>
        <a href="halaman.php?page=product/kamera/tambah" style="opacity: 1;"><img src="icon/tambahdata.png" alt=""></a></li>
                ...
                <tbody>
                    ...
                    ?>
                        <tr class="info">
                            ...
                            <td>
                                <a href="halaman.php?page=product/kamera/edit&id=<?php echo $data['id_barang'] ?>" class="btn btn-primary col-sm-5 fa fa-pencil fa-1x"></a>
                                ...
                                <script>
                                    function confirmDelete(id) {
                                        if (confirm("Apakah Anda yakin ingin menghapus data ini?")) {
                                            ...
                                            window.location.href = "/function/admin/product/kamera/hapus.php?id=" + id;
                                        } else {
